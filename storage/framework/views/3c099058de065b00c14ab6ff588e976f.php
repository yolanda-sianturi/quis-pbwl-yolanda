...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form action="<?php echo e(url('/users')); ?>" method="post">
            ...
            <div class="mb-3">
                <input class="btn btn-info" type="submit" name="" id="" value="SIMPAN">
            </div>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quis-pbwl-ajeng\resources\views/users/create.blade.php ENDPATH**/ ?>